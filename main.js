...
function app(params) {
  ...
  music_card.forEach(each_card => {
    let playbtn = each_card.querySelector(".playbtn");
    let pausebtn = each_card.querySelector(".pausebtn");
    let audio = each_card.querySelector("audio");
    let audioCurrentime = each_card.querySelector(".audioCurrentime");
    let audioDuration = each_card.querySelector(".audioDuration");
    let audioProgress = each_card.querySelector(".audioProgress");
    let progresBar = each_card.querySelector(".progresBar");
